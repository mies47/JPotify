...
/**
 * This parser is used to parse all lyrics of songmeanings.com {@link Sites}
 *
 * @author omt
...
public class SongMeaningsParser implements LyricsParser {
    ...
    public List<Lyrics> getLyrics(List<URL> urls) throws SearchLyricsException {
        ...
        if (urls != null) {
            ...
            for (URL url : urls) {
                // System.out
                // .println("In Song Meanings Parser :" + url.toString());
    ...
    private Lyrics parse(String url) throws SearchLyricsException {
        ...
        try {
            ...
            String data = document.getElementById("textblock").toString();
            if (data.length() > 0) {
